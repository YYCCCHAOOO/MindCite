...
REQUIRED_PATHS = [
    ...
    "_skills/Classification-Governance-System/scripts/build_classification_review_queue.py",
    "_skills/Classification-Governance-System/scripts/discover_open_tag_candidates.py",
    "_skills/Classification-Governance-System/scripts/prioritize_open_tag_candidates.py",
    "_skills/Classification-Governance-System/scripts/apply_tag_taxonomy_decisions.py",
